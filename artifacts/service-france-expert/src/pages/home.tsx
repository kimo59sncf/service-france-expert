      ...
      <section className="relative min-h-[90vh] flex items-center pt-20 pb-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white w-full">
          <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
            <span className="inline-block py-1 px-3 rounded-full bg-amber-400/20 backdrop-blur-md border border-amber-400/60 text-sm font-medium tracking-wide uppercase mb-6 text-amber-300">
